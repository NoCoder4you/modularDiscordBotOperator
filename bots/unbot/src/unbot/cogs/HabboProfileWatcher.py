...
class HabboWatch(commands.Cog):
    def __init__(self, bot: commands.Bot):
        ...
        bot_root = data_root()
        self.last_online_file = bot_root / "habbo_last_online.json"
        self.logoff_file = bot_root / "habbo_logoff_times.json"
        self.offline_records_file = bot_root / "habbo_offline_records.json"
        self.alert_channels_file = bot_root / "habbo_alert_channels.json"
        self.users_dir = bot_root / "USERS"
