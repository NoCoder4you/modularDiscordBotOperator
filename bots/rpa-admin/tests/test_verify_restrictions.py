...
from rpa_admin.habbo_verification_core import VerifyRestrictionStore

try:
    from rpa_admin.cogs.ServerVerifyRPA import HabboVerificationCog
    from rpa_admin.cogs.UserVerifyRestrict import VerifyRestrictionsCog
