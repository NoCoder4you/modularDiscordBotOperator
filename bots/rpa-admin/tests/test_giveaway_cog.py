...
try:
    import discord
    from rpa_admin.cogs.MiscGiveaway import GIVEAWAY_CHANNEL_ID, GiveawayCog, GiveawayRecord
except Exception:
    discord = None
...
class GiveawayCogTests(unittest.IsolatedAsyncioTestCase):
    ...
    def test_pick_winners_filters_members_that_fail_requirements(self) -> None:
        ...
        with patch("rpa_admin.cogs.MiscGiveaway.random.sample", side_effect=lambda values, k: values[:k]):
