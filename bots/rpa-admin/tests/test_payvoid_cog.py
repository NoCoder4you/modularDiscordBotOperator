...
try:
    ...
    from rpa_admin.cogs.PayVoidCog import (
...
class PayVoidCogTests(unittest.IsolatedAsyncioTestCase):
    ...
    def _cog(self, store: PayDisciplineStore) -> PayVoidCog:
        ...
        with patch("rpa_admin.cogs.PayVoidCog.PayVoidCog._weekly_reset_checker"):
    ...
    async def test_extension_loads_payvoid_cog(self) -> None:
        ...
        try:
            await bot.load_extension("rpa_admin.cogs.PayVoidCog")
