...
from rpa_admin.habbo_verification_core import HabboApiError, ServerConfigStore, VerifiedUserStore, fetch_habbo_profile
...
class UsernameChangeCog(commands.Cog):
    ...
    AUTOROLES_EXTENSION = "rpa_admin.cogs.ServerAutoRolesRPA"
