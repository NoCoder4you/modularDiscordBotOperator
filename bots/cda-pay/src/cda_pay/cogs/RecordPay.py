...
from .paths import JSON_DIR, SERVER_CONFIG_PATH
from cda_pay.timekeeping import london_now, monthly_filename, pay_time, week_start
...
class PayTracker(commands.Cog):
    def __init__(self, bot):
        self.bot = bot
        current_month_file = monthly_filename()
